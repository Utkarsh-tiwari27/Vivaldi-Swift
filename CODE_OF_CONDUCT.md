...
reported to the maintainers via GitHub's private vulnerability/report tooling
on this repository, or by opening an issue titled `Conduct contact request`
with no details, and a maintainer will follow up privately. All complaints
...
1. **Correction** — Private, written warning and clarity around the nature of
   the violation.
